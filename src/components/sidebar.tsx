    ...
    >
        ...
        {filteredNavItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {isCollapsed && (
                <div className="absolute left-16 top-1/2 transform -translate-y-1/2 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50">
      ...
      <div className="p-4 space-y-2">
        <Link
          href="/settings"
          className={cn(
            'flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-medium transition-all duration-300 hover:bg-muted text-muted-foreground hover:text-foreground group',
            isCollapsed && 'justify-center px-0 w-12 h-12 mx-auto'
          )}
        >
        ...
        <button
          className={cn(
            'flex items-center gap-3 px-3 py-2 rounded-xl text-sm font-medium transition-all duration-300 hover:bg-destructive/10 text-muted-foreground hover:text-destructive w-full group',
            isCollapsed && 'justify-center px-0 w-12 h-12 mx-auto'
          )}
        >
          <LogOut className={cn(
