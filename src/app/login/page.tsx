...
import { GraduationCap, Eye, EyeOff, Mail, Lock, Users, Briefcase, ArrowRight } from 'lucide-react';
...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-black flex items-center justify-center p-4 md:p-6 relative overflow-hidden">
      {/* Animated background elements */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 -left-40 w-80 h-80 bg-primary/20 rounded-full blur-3xl animate-pulse"></div>
        <div className="absolute bottom-0 -right-40 w-80 h-80 bg-blue-600/20 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="w-full max-w-md relative z-10 fade-in">
        <div className="bg-gradient-to-br from-slate-900/90 to-slate-950/90 backdrop-blur-2xl border border-slate-700/50 rounded-2xl shadow-2xl p-8 md:p-10">
          {/* Header */}
          <div className="text-center mb-8">
            <div className="inline-block mb-4">
              <div className="h-16 w-16 bg-gradient-to-br from-primary via-pink-500 to-blue-600 rounded-xl flex items-center justify-center shadow-lg shadow-primary/40">
          ...
          <div className="mb-8">
            <div className="flex gap-2 p-1 bg-slate-800/50 rounded-xl border border-slate-700/50">
              <button
                ...
                className={cn(
                  'flex-1 flex items-center justify-center gap-2 px-4 py-3 rounded-lg font-semibold text-sm transition-all duration-300 whitespace-nowrap',
                  selectedRole === 'student'
                    ? 'bg-gradient-to-r from-primary to-pink-500 text-white shadow-lg shadow-primary/40'
          ...
          {error && (
            <div
              className="mb-6 p-4 bg-destructive/15 border border-destructive/30 rounded-xl slide-in-up flex items-start gap-3"
              role="alert"
              aria-live="polite"
            >
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className={cn(
                    "w-full pl-12 pr-4 py-3.5 bg-slate-800/50 border-2 rounded-xl text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all duration-300",
                    emailError ? "border-destructive/50 focus:border-destructive" : "border-slate-700/50 hover:border-slate-600/50 focus:border-primary"
                  )}
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3.5 bg-slate-800/50 border-2 border-slate-700/50 rounded-xl text-white placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-primary/50 focus:border-primary transition-all duration-300 hover:border-slate-600/50"
                  placeholder="••••••••"
                  required
            ...
            <button
              ...
              disabled={loading}
              aria-busy={loading}
              className="w-full mt-8 py-3.5 px-6 bg-gradient-to-r from-primary via-pink-500 to-blue-600 text-white rounded-xl font-semibold shadow-lg shadow-primary/40 hover:shadow-xl hover:shadow-primary/50 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] relative overflow-hidden group flex items-center justify-center gap-2"
            >
              <span className="relative z-10 flex items-center justify-center gap-2">
                {loading ? (
                  ...
                  <>
                    <span>Login as {selectedRole === 'student' ? 'Student' : 'Staff'}</span>
                    <ArrowRight className="h-4 w-4" />
                  </>
                )}
              </span>
              <div className="absolute inset-0 bg-gradient-to-r from-blue-600 via-pink-500 to-primary opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
            </button>
          </form>
          ...
          <div className="relative my-8">
            ...
            <div className="relative flex justify-center text-xs">
              <span className="px-3 bg-gradient-to-br from-slate-900/90 to-slate-950/90 text-slate-500">
                or continue with
              </span>
            </div>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3.5 px-6 bg-white hover:bg-slate-50 border border-slate-300 rounded-xl disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-300 flex items-center justify-center gap-3 font-semibold shadow-sm hover:shadow-md hover:scale-[1.02] active:scale-[0.98]"
          >
          ...
          <div className="mt-8 space-y-4 text-center text-sm">
            ...
            <p className="text-xs text-slate-600 border-t border-slate-700/50 pt-4">
